...
flags.DEFINE_string('input_type', '[None,None,None,3]', 'Type of input node. Can '
...
def main(_):
    ...
    cls_model = model.Model(is_training=False, num_classes=FLAGS.num_classes, backbone=FLAGS.backbone)
